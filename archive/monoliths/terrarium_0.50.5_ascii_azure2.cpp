...
static RGB fgForChar(const World& w, char c, Season s, float sp, int tick, int x, int y) {
  ...
  // ASCII water (azure palette)
    ...
    int r = 30 + d*3 + shimmer;
    int g = 110 + d*10 + shimmer*2;
    int b = 170 + d*12 + shimmer*3;
...
default: break;
    ...
    Season s = seasonAt(tick);
    std::string title =
      std::string("Terrarium 0.50.5 | biome ") + biomeName(biome) +
