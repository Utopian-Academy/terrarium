...
static void stepEntities(World& w, Rng& r, Season s, int tick) {
  ...
  int scorpions = countEnt((char)0x1E);
  int dragonflies = countEnt((char)0x1F);
  int crabs = countEnt((char)0x20);
  int jellies = countEnt((char)0x21);
  int crawlers = countEnt((char)0x22);
  int orbs = countEnt((char)0x23);
