...
extern const uint8_t TGRASS[64];
extern const uint8_t SHRUB[64];
extern const uint8_t FERN[64];
extern const uint8_t FLOW1[64];
extern const uint8_t FLOW2[64];
extern const uint8_t TREE1[64];
extern const uint8_t TREE2[64];
extern const uint8_t BIGF[64];
extern const uint8_t MUSH[64];
extern const uint8_t REED[64];
extern const uint8_t LILY[64];
extern const uint8_t SAND[64];
extern const uint8_t CACT[64];
extern const uint8_t STONE[64];
extern const uint8_t BOUL[64];
extern const uint8_t MUD[64];
extern const uint8_t PALM[64];
extern const uint8_t FRUIT[64];
extern const uint8_t MOUN[64];
extern const uint8_t STAR[64];
extern const uint8_t EX[64];
extern const uint8_t HASH[64];
extern const uint8_t PIPE[64];
extern const uint8_t BUG[64];
extern const uint8_t BIRD[64];
extern const uint8_t RAB[64];
extern const uint8_t OWL[64];
extern const uint8_t DRGN1[64];
extern const uint8_t CRAB1[64];
extern const uint8_t SCOR1[64];
extern const uint8_t SNAKE[64];
extern const uint8_t JELY1[64];
extern const uint8_t YETI[64];
extern const uint8_t CRAW1[64];
extern const uint8_t ORB1[64];
extern const uint8_t AYY[64];
