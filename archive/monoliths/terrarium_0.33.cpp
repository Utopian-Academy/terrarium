...
//   g++ -O2 -std=c++17 terrarium_0.33.cpp -o terrarium_0.33 `sdl2-config --cflags --libs`
//
// Run examples:
//   ./terrarium_0.33 --biome meadow
//   ./terrarium_0.33 --biome tropical
//   ./terrarium_0.33 --windowed --biome tropical
//   ./terrarium_0.33 --fullscreen --biome meadow
//
// Controls:
//   SPACE pause/unpause
//   .     step (when paused)
...
int main(int argc, char** argv) {
  ...
  while (running) {
    ...
    Season s = seasonAt(tick);
    std::string title =
      std::string("Terrarium 0.33 | biome ") + biomeName(biome) +
