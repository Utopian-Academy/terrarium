...
static void stepWater(World& w, Rng& r) {
  ...
  std::vector<std::vector<int16_t>> fdx(H, std::vector<int16_t>(W, 0));
  std::vector<std::vector<int16_t>> fdy(H, std::vector<int16_t>(W, 0));
  std::vector<std::vector<uint16_t>> fmag(H, std::vector<uint16_t>(W, 0));
  ...
  for (int k=0; k<moves; ++k) {
    ...
    const int dirs[6][2] = {{0,1},{-1,1},{1,1},{-1,0},{1,0},{0,-1}};
