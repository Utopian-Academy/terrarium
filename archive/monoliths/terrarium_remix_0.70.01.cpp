...
// ===== Config =====
static constexpr const char* VERSION = "0.70.01";
...
struct SynthOut {
  ...
  bool open(const std::string& sf2, float g, const std::string& driver, const std::string& device){
    ...
    // Larger buffers + realtime priority for stable audio on Linux.
    // Requires user to be in the 'audio' group: sudo usermod -aG audio $USER
